...
hl.animation({ leaf = "layers",        enabled = true,  speed = 0.81, bezier = "easeOutQuint" })
...
hl.animation({ leaf = "workspaces",    enabled = true,  speed = 1.20, bezier = "almostLinear", style = "slide" })
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 1.20, bezier = "almostLinear", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 1.20, bezier = "almostLinear", style = "slide" })
